...
from ide.cli.tui import UsageMetrics
from ide.core.config import IDEConfig
from ide.core.schema import AgentState
from ide.events import EventSource
from ide.events.action import ChangeAgentStateAction, MessageAction
from ide.events.stream import EventStream
from ide.storage.settings.file_settings_store import FileSettingsStore
...
class TestHandleCommands:
    ...
    def mock_dependencies(self):
        ...
        sid = 'test-session-id'
        config = MagicMock(spec=IDEConfig)
    ...
    @pytest.mark.asyncio
    @patch('ide.cli.commands.handle_exit_command')
    ...
    @pytest.mark.asyncio
    @patch('ide.cli.commands.handle_help_command')
    ...
    @pytest.mark.asyncio
    @patch('ide.cli.commands.handle_init_command')
    ...
    @pytest.mark.asyncio
    @patch('ide.cli.commands.handle_status_command')
    ...
    @pytest.mark.asyncio
    @patch('ide.cli.commands.handle_new_command')
    ...
    @pytest.mark.asyncio
    @patch('ide.cli.commands.handle_settings_command')
...
class TestHandleExitCommand:
    @patch('ide.cli.commands.cli_confirm')
    @patch('ide.cli.commands.display_shutdown_message')
...
class TestHandleHelpCommand:
    @patch('ide.cli.commands.display_help')
...
class TestHandleStatusCommand:
    @patch('ide.cli.commands.display_status')
...
class TestHandleInitCommand:
    @pytest.mark.asyncio
    @patch('ide.cli.commands.init_repository')
    ...
    @pytest.mark.asyncio
    @patch('ide.cli.commands.print_formatted_text')
    @patch('ide.cli.commands.init_repository')
...
class TestHandleSettingsCommand:
    @pytest.mark.asyncio
    @patch('ide.cli.commands.display_settings')
    @patch('ide.cli.commands.cli_confirm')
    @patch('ide.cli.commands.modify_llm_settings_basic')
    ...
    @patch('ide.cli.commands.display_settings')
    @patch('ide.cli.commands.cli_confirm')
    @patch('ide.cli.commands.modify_llm_settings_advanced')
