...
###PS1JSON###
{
  ...
  "working_dir": "/home/runner/work/IDE/IDE",
  "py_interpreter_path": "/home/runner/.cache/pypoetry/virtualenvs/ide-ai-ULPBlkAi-py3.12/bin/python"
}
###PS1END###
"""
    matches = CmdOutputMetadata.matches_ps1_metadata(ps1_str)
    ...
    assert metadata.working_dir == '/home/runner/work/IDE/IDE'
    assert (
        metadata.py_interpreter_path
        == '/home/runner/.cache/pypoetry/virtualenvs/ide-ai-ULPBlkAi-py3.12/bin/python'
    )
