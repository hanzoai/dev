...
from ide.core.exceptions import UserCancelledError
from ide.llm.async_llm import AsyncLLM
from ide.llm.llm import LLM
from ide.llm.streaming_llm import StreamingLLM
...
@contextmanager
def _patch_http():
    with patch('ide.llm.llm.httpx.get', MagicMock()) as mock_http:
