...
from dev.core.exceptions import UserCancelledError
from dev.llm.async_llm import AsyncLLM
from dev.llm.llm import LLM
from dev.llm.streaming_llm import StreamingLLM
...
@contextmanager
def _patch_http():
    with patch('dev.llm.llm.httpx.get', MagicMock()) as mock_http:
