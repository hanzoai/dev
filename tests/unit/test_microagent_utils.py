...
def test_legacy_micro_agent_load(tmp_path):
    ...
    legacy_file = tmp_path / '.ide_instructions'
...
"""
    ...
    from ide.core.exceptions import MicroagentValidationError
...
def temp_microagents_dir_with_cursorrules():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        # Create .ide/microagents directory structure
        microagents_dir = root / '.ide' / 'microagents'
...
def test_load_microagents_with_cursorrules(temp_microagents_dir_with_cursorrules):
    ...
    microagents_dir = temp_microagents_dir_with_cursorrules / '.ide' / 'microagents'
