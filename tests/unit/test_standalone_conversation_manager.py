...
async def test_init_new_local_session():
    ...
    with (
        patch(
            'ide.server.conversation_manager.standalone_conversation_manager.Session',
            mock_session,
        ),
        patch(
            'ide.server.conversation_manager.standalone_conversation_manager.StandaloneConversationManager.get_running_agent_loops',
            get_running_agent_loops_mock,
        ),
    ):
        async with StandaloneConversationManager(
            sio, IDEConfig(), InMemoryFileStore(), MonitoringListener()
            ...
            with (
                patch(
                    'ide.server.conversation_manager.standalone_conversation_manager.StandaloneConversationManager.is_agent_loop_running',
