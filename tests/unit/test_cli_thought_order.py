...
from ide.cli.tui import display_event
from ide.core.config import IDEConfig
from ide.events import EventSource
from ide.events.action import Action, ActionConfirmationStatus, CmdRunAction
...
class TestThoughtDisplayIntegration:
    ...
    def test_realistic_scenario_order(self):
        ...
        with (
            patch('ide.cli.tui.display_message', side_effect=track_display_message),
            patch('ide.cli.tui.display_command', side_effect=track_display_command),
        ):
