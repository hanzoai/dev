...
from ide.storage.google_cloud import GoogleCloudFileStore
from ide.storage.local import LocalFileStore
from ide.storage.memory import InMemoryFileStore
from ide.storage.s3 import S3FileStore
...
class TestLocalFileStore(TestCase, _StorageTest):
    def setUp(self):
        ...
        self.temp_dir = tempfile.mkdtemp(prefix='ide_test_')
