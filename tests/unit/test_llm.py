...
from ide.core.exceptions import LLMNoResponseError, OperationCancelled
from ide.core.message import Message, TextContent
...
def mock_logger(monkeypatch):
    ...
    monkeypatch.setattr('ide.llm.debug_mixin.llm_prompt_logger', mock_logger)
    monkeypatch.setattr('ide.llm.debug_mixin.llm_response_logger', mock_logger)
    monkeypatch.setattr('ide.llm.llm.logger', mock_logger)
    return mock_logger
...
@patch('ide.llm.llm.litellm.get_model_info')
...
@patch('ide.llm.llm.litellm_completion')
...
@patch('ide.llm.llm.litellm.token_counter')
...
@patch('ide.llm.llm.litellm.token_counter')
@patch('ide.llm.llm.create_pretrained_tokenizer')
