...
class TestDisplayFunctions:
    @patch('ide.cli.tui.print_formatted_text')
    ...
    @patch('ide.cli.tui.display_message')
    ...
    @patch('ide.cli.tui.display_command')
    ...
    @patch('ide.cli.tui.display_command')
    @patch('ide.cli.tui.initialize_streaming_output')
    ...
    @patch('ide.cli.tui.display_command_output')
    ...
    @patch('ide.cli.tui.display_file_edit')
    ...
    @patch('ide.cli.tui.display_file_read')
    ...
    @patch('ide.cli.tui.print_container')
...
class TestInteractiveCommandFunctions:
    ...
    @patch('ide.cli.tui.print_formatted_text')
    @patch('ide.cli.tui.get_session_duration')
    ...
    @patch('ide.cli.tui.display_usage_metrics')
