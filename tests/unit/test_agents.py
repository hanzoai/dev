...
from ide.agenthub.codeact_agent.function_calling import (
    response_to_actions as codeact_response_to_actions,
)
from ide.agenthub.codeact_agent.tools import (
    BrowserTool,
    IPythonTool,
...
from ide.agenthub.codeact_agent.tools.browser import (
    _BROWSER_DESCRIPTION,
    _BROWSER_TOOL_DESCRIPTION,
)
from ide.agenthub.readonly_agent.function_calling import (
    response_to_actions as readonly_response_to_actions,
)
from ide.agenthub.readonly_agent.readonly_agent import ReadOnlyAgent
from ide.agenthub.readonly_agent.tools import (
    GlobTool,
    GrepTool,
)
from ide.controller.state.state import State
from ide.core.config import AgentConfig, LLMConfig
from ide.core.exceptions import FunctionCallNotExistsError
from ide.core.message import ImageContent, Message, TextContent
...
from ide.events.tool import ToolCallMetadata
from ide.llm.llm import LLM
from ide.memory.condenser import View
...
def test_get_system_message():
    ...
    assert 'You are IDE agent' in result.content
