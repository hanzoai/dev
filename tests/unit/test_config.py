...
from dev.core.logger import dev_logger
...
def test_compat_env_to_config(monkeypatch, setup_env):
    ...
    monkeypatch.setenv('WORKSPACE_BASE', '/repos/dev/workspace')
    ...
    assert config.workspace_base == '/repos/dev/workspace'
...
[llm]
# Not set in `dev/core/schema/config.py`
invalid_field = "test"
model = "gpt-4"
