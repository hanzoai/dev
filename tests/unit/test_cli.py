...
from ide.cli import main as cli
from ide.controller.state.state import State
from ide.events import EventSource
from ide.events.action import MessageAction
...
async def test_cleanup_session_handles_exceptions(
    ...
    with patch('ide.cli.main.logger.error') as mock_log_error:
        await cli.cleanup_session(loop, mock_agent, mock_runtime, mock_controller)
...
@pytest.mark.asyncio
@patch('ide.cli.main.display_runtime_initialization_message')
@patch('ide.cli.main.display_initialization_animation')
@patch('ide.cli.main.create_agent')
@patch('ide.cli.main.add_mcp_tools_to_agent')
@patch('ide.cli.main.create_runtime')
@patch('ide.cli.main.create_controller')
@patch(
    'ide.cli.main.create_memory',
)
@patch('ide.cli.main.run_agent_until_done')
@patch('ide.cli.main.cleanup_session')
@patch('ide.cli.main.initialize_repository_for_runtime')
async def test_run_session_without_initial_action(
    ...
    with patch(
        'ide.cli.main.read_prompt_input', new_callable=AsyncMock
    ) as mock_read_prompt:
        ...
        with patch(
            'ide.cli.main.handle_commands', new_callable=AsyncMock
...
@patch('ide.cli.main.create_runtime')
@patch('ide.cli.main.create_controller')
@patch('ide.cli.main.create_memory', new_callable=AsyncMock)
@patch('ide.cli.main.run_agent_until_done')
@patch('ide.cli.main.cleanup_session')
@patch('ide.cli.main.initialize_repository_for_runtime')
...
@pytest.mark.asyncio
@patch('ide.cli.main.parse_arguments')
@patch('ide.cli.main.setup_config_from_args')
@patch('ide.cli.main.FileSettingsStore.get_instance')
@patch('ide.cli.main.check_folder_security_agreement')
@patch('ide.cli.main.read_task')
@patch('ide.cli.main.run_session')
@patch('ide.cli.main.LLMSummarizingCondenserConfig')
@patch('ide.cli.main.NoOpCondenserConfig')
@patch('ide.cli.main.finalize_config')
@patch('ide.cli.main.aliases_exist_in_shell_config')
...
@pytest.mark.asyncio
@patch('ide.cli.main.generate_sid')
@patch('ide.cli.main.create_agent')
@patch('ide.cli.main.create_runtime')  # Returns mock_runtime
@patch('ide.cli.main.create_memory')
@patch('ide.cli.main.add_mcp_tools_to_agent')
@patch('ide.cli.main.run_agent_until_done')
@patch('ide.cli.main.cleanup_session')
@patch('ide.cli.main.read_prompt_input', new_callable=AsyncMock)  # For REPL control
@patch('ide.cli.main.handle_commands', new_callable=AsyncMock)  # For REPL control
@patch('ide.core.setup.State.restore_from_session')  # Key mock
@patch('ide.controller.AgentController.__init__')  # To check initial_state
@patch('ide.cli.main.display_runtime_initialization_message')  # Cosmetic
@patch('ide.cli.main.display_initialization_animation')  # Cosmetic
@patch('ide.cli.main.initialize_repository_for_runtime')  # Cosmetic / setup
@patch('ide.cli.main.display_initial_user_prompt')  # Cosmetic
@patch('ide.cli.main.finalize_config')
