...
from ide.cli.settings import (
    display_settings,
    modify_llm_settings_advanced,
    modify_llm_settings_basic,
)
from ide.cli.tui import UserCancelledError
from ide.core.config import IDEConfig
from ide.storage.data_models.settings import Settings
...
class TestDisplaySettings:
    ...
    def app_config(self):
        ...
        security_mock = MagicMock(spec=IDEConfig)
    ...
    @patch('ide.cli.settings.print_container')
...
class TestModifyLLMSettingsBasic:
    ...
    @pytest.mark.asyncio
    @patch('ide.cli.settings.get_supported_llm_models')
    @patch('ide.cli.settings.organize_models_and_providers')
    @patch('ide.cli.settings.PromptSession')
    @patch('ide.cli.settings.cli_confirm')
    @patch(
        'ide.cli.settings.LLMSummarizingCondenserConfig',
    ...
    @patch('ide.cli.settings.PromptSession')
    @patch('ide.cli.settings.cli_confirm')
    @patch('ide.cli.settings.print_formatted_text')
    @patch(
        'ide.cli.settings.LLMSummarizingCondenserConfig',
        MockLLMSummarizingCondenserConfig,
    )
    ...
    def test_default_provider_preference(self):
        ...
        import ide.cli.settings as settings_module
...
class TestModifyLLMSettingsAdvanced:
    ...
    @pytest.mark.asyncio
    @patch('ide.cli.settings.Agent.list_agents')
    @patch('ide.cli.settings.PromptSession')
    @patch('ide.cli.settings.cli_confirm')
    @patch(
        'ide.cli.settings.LLMSummarizingCondenserConfig',
    ...
    @patch('ide.cli.settings.NoOpCondenserConfig', MockNoOpCondenserConfig)
