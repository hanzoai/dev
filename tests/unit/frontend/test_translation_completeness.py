...
class TestTranslationCompleteness(unittest.TestCase):
    ...
    def test_translation_completeness_check_runs(self):
        ...
        # Navigate to the monorepo root and then to app/frontend
        # __file__ is in tests/unit/frontend/
        # We need to go up 3 levels to get to app/dev, then 2 more to get to the monorepo root
