...
from ide.server.app import app
from ide.server.user_auth.user_auth import UserAuth
...
def test_client():
    ...
    with (
        ...
        patch(
            'ide.server.user_auth.user_auth.UserAuth.get_instance',
            return_value=MockUserAuth(),
        ),
        patch(
            'ide.storage.settings.file_settings_store.FileSettingsStore.get_instance',
