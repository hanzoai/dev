...
from ide.microagent.microagent import KnowledgeMicroagent, RepoMicroagent
from ide.microagent.types import MicroagentMetadata, MicroagentType
from ide.server.routes.conversation import get_microagents
...
from ide.storage.data_models.conversation_metadata import ConversationMetadata
...
async def test_get_microagents():
    ...
    from ide.core.config.mcp_config import MCPConfig, MCPStdioServerConfig
    ...
    with patch('ide.server.routes.conversation.conversation_manager') as mock_manager:
        # Set up the mocks
