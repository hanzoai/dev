...
from ide.core.message import ImageContent
...
from ide.utils.prompt import PromptManager
...
def test_empty_image_url_handling():
    ...
    prompt_manager = PromptManager(prompt_dir='ide/agenthub/codeact_agent/prompts')
