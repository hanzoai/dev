...
from ide.events.event_store import EventStore
from ide.server.conversation_manager.standalone_conversation_manager import (
...
from ide.utils.conversation_summary import auto_generate_title
...
async def test_auto_generate_title_with_llm():
    ...
    with patch('ide.utils.conversation_summary.EventStore') as mock_event_store_cls:
        ...
        with patch('ide.utils.conversation_summary.LLM') as mock_llm_cls:
...
async def test_update_conversation_with_title():
    ...
    with patch(
        'ide.server.conversation_manager.standalone_conversation_manager.auto_generate_title',
