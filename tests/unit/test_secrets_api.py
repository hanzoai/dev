...
from ide.integrations.provider import (
    CustomSecret,
    ProviderToken,
    ProviderType,
)
from ide.server.routes.secrets import app as secrets_app
...
def test_client():
    ...
    with patch.dict(os.environ, {'SESSION_API_KEY': ''}, clear=False):
        ...
        with patch('ide.server.dependencies._SESSION_API_KEY', None):
...
async def test_add_git_providers_invalid_token_with_host(
    ...
    with patch(
        'ide.integrations.utils.validate_provider_token',
