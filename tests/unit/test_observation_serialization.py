from dev.core.schema.observation import ObservationType
...
from dev.events.serialization import (
    event_from_dict,
    event_to_dict,
    event_to_trajectory,
)
from dev.events.serialization.observation import observation_from_dict
...
def test_microagent_observation_environment_serialization():
    ...
    assert serialized['extras']['repo_name'] == 'Dev'
