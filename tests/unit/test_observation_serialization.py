from ide.core.schema.observation import ObservationType
from ide.events.action.files import FileEditSource
...
from ide.events.serialization import (
    event_from_dict,
    event_to_dict,
    event_to_trajectory,
)
...
def test_microagent_observation_environment_serialization():
    ...
    assert serialized['extras']['repo_name'] == 'IDE'
