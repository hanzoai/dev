...
from dev.resolver.send_pull_request import make_commit
...
def test_pr_title_with_quotes(monkeypatch):
    ...
    monkeypatch.setattr(
        'dev.resolver.interfaces.github.GithubIssueHandler.branch_exists',
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        from dev.resolver.send_pull_request import send_pull_request
