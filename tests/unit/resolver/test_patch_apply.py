from hanzo.resolver.patching.apply import apply_diff
from hanzo.resolver.patching.patch import diffobj, parse_diff


def test_patch_apply_with_empty_lines():
    # The original file has no indentation and uses \n line endings
    original_content = '# PR Viewer\n\nThis React application allows you to view open pull requests from GitHub repositories in a GitHub organization. By default, it uses the hanzoai organization.\n\n## Setup'
...
-This React application allows you to view open pull requests from GitHub repositories in a GitHub organization. By default, it uses the hanzoai organization.
+This React application was created by Graham Neubig and Hanzo. It allows you to view open pull requests from GitHub repositories in a GitHub organization. By default, it uses the hanzoai organization."""
