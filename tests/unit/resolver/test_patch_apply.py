from ide.resolver.patching.apply import apply_diff
from ide.resolver.patching.patch import diffobj, parse_diff
...
-This React application allows you to view open pull requests from GitHub repositories in a GitHub organization. By default, it uses the hanzoai organization.
+This React application was created by Graham Neubig and IDE. It allows you to view open pull requests from GitHub repositories in a GitHub organization. By default, it uses the hanzoai organization."""
