...
This folder contains integration tests that verify the functionality of IDE' runtime environments and their interactions with various tools and features.
...
- `RUN_AS_IDE`: Set to 'True' to run tests as ide user (default), 'False' for root
