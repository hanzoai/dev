...
from dev.core.config.config_utils import OH_DEFAULT_AGENT
...
from dev.events.observation.commands import CmdOutputObservation
...
def test_simple_replay(temp_dir, runtime_cls, run_as_dev):
    """
...
def test_simple_gui_replay(temp_dir, runtime_cls, run_as_dev):
    """
    A simple replay test that involves simple terminal operations and edits
...
def test_replay_wrong_initial_state(temp_dir, runtime_cls, run_as_dev):
    """
...
def test_replay_basic_interactions(temp_dir, runtime_cls, run_as_dev):
    """
