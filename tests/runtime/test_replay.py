...
from ide.core.config.config_utils import OH_DEFAULT_AGENT
...
from ide.events.action.message import MessageAction
from ide.events.event import EventSource
from ide.events.observation.commands import CmdOutputObservation
...
def test_simple_replay(temp_dir, runtime_cls, run_as_ide):
    """
...
def test_simple_gui_replay(temp_dir, runtime_cls, run_as_ide):
    """
    A simple replay test that involves simple terminal operations and edits
...
def test_replay_wrong_initial_state(temp_dir, runtime_cls, run_as_ide):
    """
...
def test_replay_basic_interactions(temp_dir, runtime_cls, run_as_ide):
    """
