...
def test_browser_disabled(temp_dir, runtime_cls, run_as_ide):
    runtime, _ = _load_runtime(temp_dir, runtime_cls, run_as_ide, enable_browser=False)
...
def test_simple_browse(temp_dir, runtime_cls, run_as_ide):
...
def test_browser_navigation_actions(temp_dir, runtime_cls, run_as_ide):
...
def test_browser_form_interactions(temp_dir, runtime_cls, run_as_ide):
...
def test_browser_interactive_actions(temp_dir, runtime_cls, run_as_ide):
...
def test_browser_file_upload(temp_dir, runtime_cls, run_as_ide):
...
def test_read_pdf_browse(temp_dir, runtime_cls, run_as_ide):
    runtime, config = _load_runtime(temp_dir, runtime_cls, run_as_ide)
    try:
...
def test_read_png_browse(temp_dir, runtime_cls, run_as_ide):
    runtime, config = _load_runtime(temp_dir, runtime_cls, run_as_ide)
    try:
...
def test_download_file(temp_dir, runtime_cls, run_as_ide):
