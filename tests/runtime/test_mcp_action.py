...
from ide.core.config.mcp_config import MCPSSEServerConfig, MCPStdioServerConfig
from ide.core.logger import ide_logger as logger
from ide.events.action import CmdRunAction, MCPAction
from ide.events.observation import CmdOutputObservation, MCPObservation
...
def sse_mcp_docker_server():
    ...
    from ide.runtime.utils.log_streamer import LogStreamer
...
@pytest.mark.asyncio
async def test_fetch_mcp_via_stdio(temp_dir, runtime_cls, run_as_ide):
    ...
    runtime, config = _load_runtime(
        temp_dir, runtime_cls, run_as_ide, override_mcp_config=override_mcp_config
    )
...
async def test_filesystem_mcp_via_sse(
    temp_dir, runtime_cls, run_as_ide, sse_mcp_docker_server
):
