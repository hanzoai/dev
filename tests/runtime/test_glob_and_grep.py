...
def test_grep_to_cmdrun_quotes(temp_dir, runtime_cls, run_as_ide):
...
def test_grep_to_cmdrun_special_chars(runtime_cls, run_as_ide, temp_dir):
...
def test_grep_to_cmdrun_paths_with_spaces(runtime_cls, run_as_ide, temp_dir):
...
def test_glob_to_cmdrun_special_patterns(runtime_cls, run_as_ide, temp_dir):
...
def test_glob_to_cmdrun_paths_with_spaces(runtime_cls, run_as_ide, temp_dir):
