...
from dev.controller import AgentController
from dev.controller.agent import Agent
from dev.controller.replay import ReplayManager
from dev.controller.state.state import State
from dev.core.config import AgentConfig, AppConfig, LLMConfig
from dev.core.exceptions import AgentRuntimeUnavailableError
from dev.core.logger import DevLoggerAdapter
from dev.core.schema.agent import AgentState
from dev.events.action import ChangeAgentStateAction, MessageAction
from dev.events.event import Event, EventSource
from dev.events.stream import EventStream
from dev.integrations.provider import PROVIDER_TOKEN_TYPE, ProviderHandler
from dev.memory.memory import Memory
from dev.microagent.microagent import BaseMicroAgent
from dev.runtime import get_runtime_cls
from dev.runtime.base import Runtime
from dev.runtime.impl.remote.remote_runtime import RemoteRuntime
from dev.security import SecurityAnalyzer, options
from dev.storage.files import FileStore
from dev.utils.async_utils import EXECUTOR, call_sync_from_async
...
class AgentSession:
    ...
    async def _create_memory(
        ...
        if self.runtime:
            ...
            # loads microagents from repo/.dev/microagents
