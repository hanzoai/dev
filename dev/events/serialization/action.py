...
from dev.core.exceptions import LLMMalformedActionError
...
from dev.events.action.commands import (
    CmdRunAction,
...
def handle_action_deprecated_args(args: dict[str, Any]) -> dict[str, Any]:
    # keep_prompt has been deprecated in https://github.com/hanzoai/dev/pull/4881
