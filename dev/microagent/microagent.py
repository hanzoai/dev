...
from dev.microagent.types import MicroAgentMetadata, MicroAgentType
...
class BaseMicroAgent(BaseModel):
    ...
    def load(
        ...
        # Legacy repo instructions are stored in .dev_instructions
        if path.name == '.dev_instructions':
...
class RepoMicroAgent(BaseMicroAgent):
    ...
    RepoMicroAgents are loaded from `.dev/microagents/repo.md` files within repositories
...
def load_microagents_from_dir(
    ...
    Args:
        microagent_dir: Path to the microagents directory (e.g. .dev/microagents)
    ...
    # Load all agents from .dev/microagents directory
