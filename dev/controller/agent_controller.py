...
from dev.events.action.agent import CondensationAction, RecallAction
...
from dev.events.serialization.event import event_to_trajectory, truncate_content
...
class AgentController:
    ...
    async def start_delegate(self, action: AgentDelegateAction) -> None:
        ...
        Dev is a multi-agentic system. A `task` is a conversation between
        Dev (the whole system) and the user, which might involve one or more inputs
