...
class State:
    """
    Represents the running state of an agent in the Dev system, saving data of its operation and memory.
    ...
    def to_llm_metadata(self, agent_name: str) -> dict:
        return {
            ...
            'trace_version': dev.__version__,
            'tags': [
                f'agent:{agent_name}',
                f'web_host:{os.environ.get("WEB_HOST", "unspecified")}',
                f'dev_version:{dev.__version__}',
            ],
        }
