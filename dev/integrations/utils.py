...
from dev.integrations.github.github_service import GitHubService
from dev.integrations.gitlab.gitlab_service import GitLabService
from dev.integrations.provider import ProviderType
