...
from dev.core.exceptions import LLMResponseError
from dev.events.event import Event
from dev.events.observation import CmdOutputMetadata
...
def dumps(obj, **kwargs):
    ...
    return json.dumps(obj, cls=DevJSONEncoder, **kwargs)
