...
It is responsible for executing actions received from Dev backend and producing observations.
...
from dev_aci.editor.editor import OHEditor
from dev_aci.editor.exceptions import ToolError
from dev_aci.editor.results import ToolResult
...
from dev.core.exceptions import BrowserUnavailableException
...
from dev.runtime.browser import browse
from dev.runtime.browser.browser_env import BrowserEnv
from dev.runtime.plugins import ALL_PLUGINS, JupyterPlugin, Plugin, VSCodePlugin
from dev.runtime.utils.bash import BashSession
from dev.runtime.utils.files import insert_lines, read_lines
from dev.runtime.utils.memory_monitor import MemoryMonitor
from dev.runtime.utils.runtime_init import init_user_and_working_directory
from dev.runtime.utils.system_stats import get_system_stats
from dev.utils.async_utils import call_sync_from_async, wait_all
    ...
    async def ainit(self):
        ...
        if 'agent_skills' in self.plugins and 'jupyter' in self.plugins:
            obs = await self.run_ipython(
                IPythonRunCellAction(
                    code='from dev.runtime.plugins.agent_skills.agentskills import *\n'
                )
            )
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--username', type=str, help='User to run as', default='dev'
    )
