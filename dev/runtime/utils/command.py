...
def get_action_execution_server_startup_command(
    ...
    username = override_username or (
        'dev' if app_config.run_as_dev else 'root'
    )
    user_id = override_user_id or (
        sandbox_config.user_id if app_config.run_as_dev else 0
    )
    ...
    base_cmd = [
        *python_prefix,
        ...
        '-u',
        '-m',
        'dev.runtime.action_execution_server',
        str(server_port),
        '--working-dir',
