...
function activate(context) {
    ...
    let startMonitorCommand = vscode.commands.registerCommand('dev-memory-monitor.startMemoryMonitor', function () {
        memoryMonitor.start();
    });

    // Register memory monitor stop command
    let stopMonitorCommand = vscode.commands.registerCommand('dev-memory-monitor.stopMemoryMonitor', function () {
        memoryMonitor.stop();
    });

    // Register memory details command
    let showMemoryDetailsCommand = vscode.commands.registerCommand('dev-memory-monitor.showMemoryDetails', function () {
