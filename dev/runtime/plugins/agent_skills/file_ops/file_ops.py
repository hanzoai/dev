"""File operations module for Dev agent.

This module provides a collection of file manipulation skills that enable the Dev
...
from dev.linter import DefaultLinter, LintResult
