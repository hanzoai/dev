...
This folder implements a skill/tool set `agentskills` for Dev.
...
The skill set can contain a bunch of wrapped tools for agent ([many examples here](https://github.com/hanzoai/dev/pull/1914)), for example:
