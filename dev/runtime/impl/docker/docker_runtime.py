...
from dev.core.logger import DEBUG, DEBUG_RUNTIME
from dev.core.logger import dev_logger as logger
from dev.events import EventStream
from dev.runtime.builder import DockerRuntimeBuilder
from dev.runtime.impl.action_execution.action_execution_client import (
    ActionExecutionClient,
)
from dev.runtime.impl.docker.containers import stop_all_containers
...
from dev.runtime.utils.log_streamer import LogStreamer
from dev.runtime.utils.runtime_build import build_runtime_image
from dev.utils.async_utils import call_sync_from_async
from dev.utils.shutdown_listener import add_shutdown_listener
from dev.utils.tenacity_stop import stop_if_should_exit

CONTAINER_NAME_PREFIX = 'dev-runtime-'
...
class DockerRuntime(ActionExecutionClient):
    ...
    def _init_container(self):
        ...
        if (
            ...
            # e.g. result would be: {"/home/user/dev/workspace": {'bind': "/workspace", 'mode': 'rw'}}
            volumes = {
        ...
        try:
            self.container = self.docker_client.containers.run(
                ...
                ports=port_mapping,
                working_dir='/dev/code/',  # do not change this!
    ...
    def close(self, rm_all_containers: bool | None = None):
        ...
        Parameters:
        - rm_all_containers (bool): Whether to remove all containers with the 'dev-sandbox-' prefix
        """
        super().close()
