...
from ide.core.config import get_llm_config_arg, get_parser, load_ide_config
...
if __name__ == '__main__':
    ...
    # Check https://github.com/hanzoai/ide/blob/main/evaluation/swe_bench/README.md#configure-ide-and-your-llm
