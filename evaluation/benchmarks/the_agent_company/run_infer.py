...
from ide.events.observation import BrowserOutputObservation, CmdOutputObservation
...
def get_config(
    ...
    config = IDEConfig(
        ...
        # we mount trajectories path so that trajectories, generated by IDE
...
if __name__ == '__main__':
    ...
    # 1) trajectory is dumped by IDE library (on host machine), but it's needed by
