...
- `git-version`: The git commit hash or release tag of IDE to evaluate (e.g., `HEAD` or `0.6.2`)
...
1. Fork [our HuggingFace evaluation outputs](https://huggingface.co/spaces/IDE/evaluation).
...
- [IDE Documentation](https://github.com/hanzoai/ide)
- [HuggingFace Datasets](https://huggingface.co/datasets)

For any questions or issues, please open an issue in the [IDE repository](https://github.com/hanzoai/ide/issues).
