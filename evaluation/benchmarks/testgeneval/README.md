...
- `git-version`: The git commit hash or release tag of Dev to evaluate (e.g., `HEAD` or `0.6.2`)
...
1. Fork [our HuggingFace evaluation outputs](https://huggingface.co/spaces/Dev/evaluation).
...
- [Dev Documentation](https://github.com/hanzoai/dev)
- [HuggingFace Datasets](https://huggingface.co/datasets)

For any questions or issues, please open an issue in the [Dev repository](https://github.com/hanzoai/dev/issues).
