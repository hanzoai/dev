...
from ide.events.observation import AgentDelegateObservation
...
<body>
    ...
    <script>
        document.getElementById('showButton').addEventListener('click', function() {
            document.getElementById('result').innerText = 'The answer is IDE is all you need!';
        });
    </script>
</body>
</html>
...
class Test(BaseIntegrationTest):
    ...
    def verify_result(cls, runtime: Runtime, histories: list[Event]) -> TestResult:
        ...
        # check if the "The answer is IDE is all you need!" is in any message
        message_actions = [
            event
        ...
        for event in message_actions:
            try:
                ...
                if 'IDE is all you need!' in content:
