# IDE - Regression Test Framework

IDE project is an open-source software engineering AI that can solve various software engineering tasks. This repository contains the regression test framework for IDE project.

## Running the Tests

To run the tests for IDE project, you can use the provided test runner script. Follow these steps:
...
The test cases for IDE project are organized in the `cases/` directory. Each test case has the following structure:
...
- `outputs/`: This directory contains the output generated by IDE for each agent.
- `outputs/*/workspace/`: This directory contains the actual output files generated by IDE.
- `test_*.py`: These are the test scripts that validate the output of IDE.
...
- `run_test_case`: A fixture that runs IDE and generates the workspace for the current test case.
