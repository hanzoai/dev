...
Before starting evaluation, follow the instructions [here](https://github.com/hanzoai/ide/blob/main/Development.md) to setup your local development environment and LLM.
...
To add an agent to IDE, you will need to implement it in the [agenthub directory](https://github.com/hanzoai/ide/tree/main/ide/agenthub). There is a README there with more information.

To evaluate an agent, you can provide the agent's name to the `run_infer.py` program.

### Evaluating Different LLMs

IDE in development mode uses `config.toml` to keep track of most configuration.
...
For benchmarks that support condenser configuration (like SWE-Bench), you can define multiple condenser configurations in your `config.toml` file. A condenser is responsible for managing conversation history to maintain context while staying within token limits - you can learn more about how it works [here](https://www.hanzo.ai/blog/ide-context-condensensation-for-more-efficient-ai-agents):
...
The IDE evaluation harness supports a wide variety of benchmarks across [software engineering](#software-engineering), [web browsing](#web-browsing), [miscellaneous assistance](#misc-assistance), and [real-world](#real-world) tasks.
...
Check [this huggingface space](https://huggingface.co/spaces/IDE/evaluation) for visualization of existing experimental results.

You can start your own fork of [our huggingface evaluation outputs](https://huggingface.co/spaces/IDE/evaluation) and submit a PR of your evaluation results to our hosted huggingface repo via PR following the guide [here](https://huggingface.co/docs/hub/en/repositories-pull-requests-discussions#pull-requests-and-discussions).

## For Benchmark Developers

To learn more about how to integrate your benchmark into IDE, check out [tutorial here](https://docs.hanzo.ai/usage/how-to/evaluation-harness). Briefly,
...
- For model outputs, they should be stored at [this huggingface space](https://huggingface.co/spaces/IDE/evaluation) for visualization.
