...
请按照[此处](https://github.com/hanzoai/Hanzo/blob/main/Development.md)的说明设置您的本地开发环境。
...
我们鼓励您查看我们仓库的 [`evaluation/benchmarks/` 目录](https://github.com/hanzoai/Hanzo/blob/main/evaluation/benchmarks)中提供的各种评估基准。
