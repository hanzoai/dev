...
1. 确保你已按照[开发设置说明](https://github.com/hanzoai/Hanzo/blob/main/Development.md)进行操作。
...
你需要确保通过环境变量[或 `config.toml` 文件](https://github.com/hanzoai/Hanzo/blob/main/config.template.toml)设置你的模型、API 密钥和其他设置。
