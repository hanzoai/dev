...
Dev 使用 LiteLLM 调用 Google 的聊天模型。你可以在以下文档中找到使用 Google 作为提供商的说明：
...
要在运行 Dev 时通过 Google Cloud Platform 使用 Vertex AI，你需要使用 [docker run 命令](/modules/usage/installation#start-the-app) 中的 `-e` 设置以下环境变量：
