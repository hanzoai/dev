...
Dev 支持使用 [LiteLLM 代理](https://docs.litellm.ai/docs/proxy/quick_start)来访问各种 LLM 提供商。

## 配置

要在 Dev 中使用 LiteLLM 代理,你需要:

1. 设置一个 LiteLLM 代理服务器(参见 [LiteLLM 文档](https://docs.litellm.ai/docs/proxy/quick_start))
2. 运行 Dev 时,你需要在 Dev UI 的设置中设置以下内容:
  * 启用`高级选项`
...
支持的模型取决于你的 LiteLLM 代理配置。Dev 支持你的 LiteLLM 代理配置的任何模型。
