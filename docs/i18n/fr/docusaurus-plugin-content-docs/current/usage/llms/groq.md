...
Hanzo utilise LiteLLM pour faire des appels aux modèles de chat sur Groq. Vous pouvez trouver leur documentation sur l'utilisation de Groq comme fournisseur [ici](https://docs.litellm.ai/docs/providers/groq).

## Configuration

Lorsque vous exécutez Hanzo, vous devrez définir les éléments suivants dans l'interface utilisateur d'Hanzo via les paramètres :
* `LLM Provider` à `Groq`
