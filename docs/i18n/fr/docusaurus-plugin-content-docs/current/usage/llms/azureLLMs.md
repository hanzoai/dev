...
Hanzo utilise LiteLLM pour les appels de complétion. Vous pouvez trouver leur documentation sur Azure [ici](https://docs.litellm.ai/docs/providers/azure)

### Configurations openai Azure

Lors de l'exécution de l'image Docker Hanzo, vous devrez définir les variables d'environnement suivantes en utilisant `-e` :
...
Lors de l'exécution d'Hanzo dans Docker, définissez les variables d'environnement suivantes en utilisant `-e` :
