...
Avec l'installation standard, les données de session sont stockées en mémoire. Actuellement, si le service Hanzo est redémarré,
...
...
file_store="local"
file_store_path="/absolute/path/to/hanzo/cache/directory"
