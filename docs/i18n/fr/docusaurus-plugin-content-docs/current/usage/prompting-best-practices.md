...
Lorsque vous travaillez avec le développeur de logiciels Hanzo AI, il est crucial de fournir des prompts clairs et efficaces. Ce guide décrit les meilleures pratiques pour créer des prompts qui produiront les réponses les plus précises et utiles.
...
Voir [Getting Started with Hanzo](./getting-started) pour plus d'exemples de prompts utiles.
