...
Vous pouvez également exécuter Dev en mode [headless scriptable](https://docs.all-hands.dev/modules/usage/how-to/headless-mode), en tant que [CLI interactive](https://docs.all-hands.dev/modules/usage/how-to/cli-mode), ou en utilisant l'[Action GitHub Dev](https://docs.all-hands.dev/modules/usage/how-to/github-action).
...
- Pour une version spécifique, utilisez `docker.all-hands.dev/hanzoai/dev:$VERSION`, en remplaçant $VERSION par le numéro de version.
...
- Pour la version de développement la plus à jour, vous pouvez utiliser `docker.all-hands.dev/hanzoai/dev:main`. Cette version est instable et n'est recommandée qu'à des fins de test ou de développement.
