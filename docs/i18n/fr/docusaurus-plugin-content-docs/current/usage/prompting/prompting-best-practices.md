...
Lorsque vous travaillez avec le développeur de logiciels Dev AI, il est crucial de fournir des prompts clairs et efficaces. Ce guide décrit les meilleures pratiques pour créer des prompts qui produiront les réponses les plus précises et les plus utiles.
...
N'oubliez pas, plus votre prompt est précis et informatif, mieux l'IA pourra vous aider à développer ou à modifier le logiciel Dev.

Voir [Démarrer avec Dev](../getting-started) pour plus d'exemples de prompts utiles.
