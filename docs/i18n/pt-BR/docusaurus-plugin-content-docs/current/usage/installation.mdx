...
Você também pode [conectar o Dev ao seu sistema de arquivos local](https://docs.all-hands.dev/modules/usage/runtimes#connecting-to-your-filesystem),
executar o Dev em um [modo headless programável](https://docs.all-hands.dev/modules/usage/how-to/headless-mode),
