...
O Dev usa o LiteLLM para fazer chamadas aos modelos de chat do Google. Você pode encontrar a documentação sobre como usar o Google como provedor:
...
Para usar o Vertex AI através do Google Cloud Platform ao executar o Dev, você precisará definir as seguintes variáveis de ambiente usando `-e` no [comando docker run](../installation#running-dev):
...
Em seguida, defina o seguinte na interface do usuário do Dev através das Configurações:
