...
Microagentes públicos são diretrizes especializadas acionadas por palavras-chave para todos os usuários do Dev.
Eles são definidos em arquivos markdown no diretório
[`microagents/knowledge/`](https://github.com/hanzoai/dev/tree/main/microagents/knowledge).
...
diretório [`microagents/knowledge/`](https://github.com/hanzoai/dev/tree/main/microagents/knowledge/).
...
Crie um novo arquivo markdown em [`microagents/knowledge/`](https://github.com/hanzoai/dev/tree/main/microagents/knowledge/)
...
Veja os [microagentes públicos atuais](https://github.com/hanzoai/dev/tree/main/microagents/knowledge) para
mais exemplos.
