...
[concede acesso ao repositório do Dev Cloud](./dev-cloud.md#adding-repository-access).

## Uso

Após conceder acesso ao repositório do Dev Cloud, você pode usar o Resolvedor do GitHub na Nuvem nos problemas e pull requests
do repositório.

### Issues

No seu repositório, rotule um issue com `dev`. O Dev irá:

1. Comentar no issue para informar que está trabalhando nele.
   - Você pode clicar no link para acompanhar o progresso no Dev Cloud.
...
Para fazer o Dev trabalhar em pull requests, use `@dev` em comentários de nível superior ou inline para: - Fazer perguntas - Solicitar atualizações - Obter explicações de código
