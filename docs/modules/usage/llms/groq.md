...
Dev uses LiteLLM to make calls to chat models on Groq. You can find their documentation on using Groq as a provider [here](https://docs.litellm.ai/docs/providers/groq).
...
would access any OpenAI-compatible endpoint. In the Dev UI through the Settings:
