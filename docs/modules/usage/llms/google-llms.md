...
Hanzo uses LiteLLM to make calls to Google's chat models. You can find their documentation on using Google as a provider:
...
To use Vertex AI through Google Cloud Platform when running Hanzo, you'll need to set the following environment
...
Then set the following in the Hanzo UI through the Settings:
