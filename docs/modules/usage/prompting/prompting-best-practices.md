...
When working with Hanzo AI software developer, it's crucial to provide clear and effective prompts. This guide outlines best practices for creating prompts that will yield the most accurate and useful responses.
...
Remember, the more precise and informative your prompt is, the better the AI can assist you in developing or modifying the Hanzo software.

See [Getting Started with Hanzo](../getting-started) for more examples of helpful prompts.
