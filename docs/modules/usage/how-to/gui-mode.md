...
Dev provides a Graphical User Interface (GUI) mode for interacting with the AI assistant.

## Installation and Setup

1. Follow the installation instructions to install Dev.
2. After running the command, access Dev at [http://localhost:3000](http://localhost:3000).
...
Dev automatically exports a `GITHUB_TOKEN` to the shell environment if it is available. This can happen in two ways:
...
**Dev Cloud**: The token is obtained through GitHub OAuth authentication.

<details>
  <summary>OAuth Authentication</summary>

  When using Dev Cloud, the GitHub OAuth flow requests the following permissions:
  ...
  To authenticate Dev:
   ...
   - Authorize Dev to access your GitHub account.
...
Remember, the GUI mode of Dev is designed to make your interaction with the AI assistant as smooth and intuitive
