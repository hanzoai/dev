...
A Runtime is an environment where the Dev agent can edit files and run
commands.

By default, Dev uses a Docker-based runtime, running on your local computer.
...
if you're running many Dev conversations in parallel (e.g. to do evaluation).
...
Dev supports several different runtime environments:
...
- [Dev Remote Runtime](./runtimes/remote.md) - Cloud-based runtime for parallel execution (beta)
