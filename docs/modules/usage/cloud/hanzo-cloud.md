...
Dev Cloud is the cloud hosted version of Dev by Hanzo AI.

## Accessing Dev Cloud

Currently, users are being admitted to access Dev Cloud in waves. To sign up,
...
After visiting Dev Cloud, you will be asked to connect with your GitHub account:
1. After reading and accepting the terms of service, click `Connect to GitHub`.
2. Review the permissions requested by Dev and then click `Authorize Dev AI`.
   - Dev will require some permissions from your GitHub account. To read more about these permissions,
...
You can grant Dev specific repository access:
1. Click the `Select a GitHub project` dropdown, select `Add more repositories...`.
2. Select the organization, then choose the specific repositories to grant Dev access to.
   - Dev requests short-lived tokens (8-hour expiry) with these permissions:
