...
So you've [run Hanzo](./installation) and have
[set up your LLM](./installation#setup). Now what?

Hanzo can help you tackle a wide variety of engineering tasks. But the technology
...
Hanzo can also do a great job adding new code to an existing code base.

For example, you can ask Hanzo to add a new GitHub action to your project
which lints your code. Hanzo may take a peek at your codebase to see what language
...
Some tasks might require a bit more context. While Hanzo can use `ls` and `grep`
...
Hanzo does great at refactoring existing code, especially in small chunks.
...
Hanzo can also help you track down and fix bugs in your code. But as any
developer knows, bug fixing can be extremely tricky, and often Hanzo will need more context.
It helps if you've diagnosed the bug, but want Hanzo to figure out the logic.
...
Hanzo is capable of helping out on just about any coding task but it takes some practice
...
See [Prompting Best Practices](./prompting/prompting-best-practices) for more tips on how to get the most out of Hanzo.
