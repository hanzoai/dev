...
impl From<dev_protocol::config_types::ReasoningEffort> for ReasoningEffort {
    fn from(v: dev_protocol::config_types::ReasoningEffort) -> Self {
        match v {
            dev_protocol::config_types::ReasoningEffort::Minimal => ReasoningEffort::Minimal,
            dev_protocol::config_types::ReasoningEffort::Low => ReasoningEffort::Low,
            dev_protocol::config_types::ReasoningEffort::Medium => ReasoningEffort::Medium,
            dev_protocol::config_types::ReasoningEffort::High => ReasoningEffort::High,
        }
    }
}

impl From<dev_protocol::config_types::ReasoningSummary> for ReasoningSummary {
    fn from(v: dev_protocol::config_types::ReasoningSummary) -> Self {
        match v {
            dev_protocol::config_types::ReasoningSummary::Auto => ReasoningSummary::Auto,
            dev_protocol::config_types::ReasoningSummary::Concise => ReasoningSummary::Concise,
            dev_protocol::config_types::ReasoningSummary::Detailed => ReasoningSummary::Detailed,
            dev_protocol::config_types::ReasoningSummary::None => ReasoningSummary::None,
        }
    }
}
