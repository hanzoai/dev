        ...
        loop {
            match Pin::new(&mut this.inner).poll_next(cx) {
                ...
                Poll::Ready(Some(Ok(ResponseEvent::OutputItemDone { item, sequence_number: _, .. }))) => {
                    ...
                    let is_assistant_delta = matches!(&item, dev_protocol::models::ResponseItem::Message { role, .. } if role == "assistant");
                ...
                Poll::Ready(Some(Ok(ResponseEvent::Completed {
                    ...
                    if !this.cumulative.is_empty() {
                        let aggregated_message = ResponseItem::Message {
                            ...
                            role: "assistant".to_string(),
                            content: vec![dev_protocol::models::ContentItem::OutputText {
