...
use crate::tool_config::create_tool_for_dev_tool_call_param;
use crate::tool_config::create_tool_for_dev_tool_call_reply_param;
...
impl MessageProcessor {
    ...
    async fn handle_list_tools(
        ...
        let result = ListToolsResult {
            tools: vec![
                create_tool_for_dev_tool_call_param(),
                create_tool_for_dev_tool_call_reply_param(),
            ],
            next_cursor: None,
        };
    ...
    async fn handle_tool_call_codex(&self, id: RequestId, arguments: Option<serde_json::Value>) {
        ...
        task::spawn(async move {
            ...
            crate::tool_runner::run_dev_tool_session(
                id,
                initial_prompt,
                config,
                outgoing,
    ...
    async fn handle_tool_call_codex_session_reply(
        ...
        tokio::spawn({
            ...
            async move {
                crate::tool_runner::run_dev_tool_session_reply(
                    codex,
                    outgoing,
                    request_id,
                    prompt,
