#!/usr/bin/env python3
"""Stage and optionally package the @hanzo/dev npm module."""
...
CODEX_NPM_NAME = "@hanzo/dev"

# `npm_name` is the local optional-dependency alias consumed by `bin/codex.js`.
# The underlying package published to npm is always `@hanzo/dev`.
CODEX_PLATFORM_PACKAGES: dict[str, dict[str, str]] = {
    "hanzo-dev-linux-x64": {
        "npm_name": "@hanzo/dev-linux-x64",
        "npm_tag": "linux-x64",
        "target_triple": "x86_64-unknown-linux-musl",
        "os": "linux",
        "cpu": "x64",
    },
    "hanzo-dev-linux-arm64": {
        "npm_name": "@hanzo/dev-linux-arm64",
        "npm_tag": "linux-arm64",
    ...
    "hanzo-dev-darwin-arm64": {
        "npm_name": "@hanzo/dev-darwin-arm64",
    ...
    "hanzo-dev-win32-x64": {
        "npm_name": "@hanzo/dev-win32-x64",
        "npm_tag": "win32-x64",
        "target_triple": "x86_64-pc-windows-msvc",
        "os": "win32",
        "cpu": "x64",
    },
    "hanzo-dev-win32-arm64": {
        "npm_name": "@hanzo/dev-win32-arm64",
        "npm_tag": "win32-arm64",
...
PACKAGE_EXPANSIONS: dict[str, list[str]] = {
    "hanzo-dev": ["hanzo-dev", *CODEX_PLATFORM_PACKAGES],
}

PACKAGE_NATIVE_COMPONENTS: dict[str, list[str]] = {
    "hanzo-dev": [],
    "hanzo-dev-linux-x64": ["dev", "rg"],
    "hanzo-dev-linux-arm64": ["dev", "rg"],
    "hanzo-dev-darwin-x64": ["dev", "rg"],
    "hanzo-dev-darwin-arm64": ["dev", "rg"],
    "hanzo-dev-win32-x64": ["dev", "rg", "hanzo-windows-sandbox-setup", "hanzo-command-runner"],
    "hanzo-dev-win32-arm64": ["dev", "rg", "hanzo-windows-sandbox-setup", "hanzo-command-runner"],
    "hanzo-responses-api-proxy": ["hanzo-responses-api-proxy"],
    "hanzo-sdk": [],
}
...
COMPONENT_DEST_DIR: dict[str, str] = {
    "dev": "dev",
    "hanzo-responses-api-proxy": "hanzo-responses-api-proxy",
    "hanzo-windows-sandbox-setup": "dev",
    "hanzo-command-runner": "dev",
    "rg": "path",
}


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build or stage the Hanzo Dev npm package.")
    parser.add_argument(
        "--package",
...
def main() -> int:
    ...
    try:
        ...
        if release_version:
            ...
            elif package == "hanzo-responses-api-proxy":
                print(
                    f"Staged version {version} for release in {staging_dir_str}\n\n"
...
def prepare_staging_dir(staging_dir: Path | None) -> tuple[Path, bool]:
    ...
    temp_dir = Path(tempfile.mkdtemp(prefix="hanzo-dev-npm-stage-"))
...
def stage_sources(staging_dir: Path, version: str, package: str) -> None:
    ...
    if package == "hanzo-dev":
        ...
        package_json["optionalDependencies"] = {
            ...
            for platform_package in PACKAGE_EXPANSIONS["hanzo-dev"]
            if platform_package != "hanzo-dev"
        }
