...
const ANNOUNCEMENT_TIP_URL: &str =
    "https://raw.githubusercontent.com/hanzoai/dev/main/announcement_tip.toml";

const IS_MACOS: bool = cfg!(target_os = "macos");
const IS_WINDOWS: bool = cfg!(target_os = "windows");

const PAID_TOOLTIP: &str = "*New* Try **Hanzo Dev** with 2x rate limits. Visit hanzo.ai for details.";
const PAID_TOOLTIP_WINDOWS: &str = "*New* Try **Hanzo Dev**, now available on **Windows**, with 2x rate limits. Visit hanzo.ai for details.";
const PAID_TOOLTIP_NON_MAC: &str = "*New* 2x rate limits available. Visit hanzo.ai for details.";
const FAST_TOOLTIP: &str = "*New* Use **/fast** to enable our fastest inference at 2X plan usage.";
const OTHER_TOOLTIP: &str = "*New* Build faster with **Hanzo Dev**. Visit hanzo.ai for details.";
const OTHER_TOOLTIP_NON_MAC: &str = "*New* Build faster with Hanzo Dev.";
const FREE_GO_TOOLTIP: &str =
    "*New* For a limited time, Hanzo Dev is included in your plan for free -- let’s build together.";
