...
pub(crate) fn build_specs_with_discoverable_tools(
    ...
    use crate::tools::handlers::collab::CloseAgentHandler;
    use crate::tools::handlers::collab::ResumeAgentHandler;
    use crate::tools::handlers::collab::SendInputHandler;
    use crate::tools::handlers::collab::SpawnAgentHandler;
    use crate::tools::handlers::collab::WaitHandler;
    use std::sync::Arc;
