...
This agent helps create new microagents in the `.ide/microagents` directory by providing guidance and templates.
...
- Create a markdown file in `.ide/microagents/` with an appropriate name (e.g., `github.md`, `google_workspace.md`)
...
- [Microagents Overview](https://docs.hanzo.ai/usage/prompting/microagents-overview)
- [Example GitHub Microagent](https://github.com/hanzoai/ide/blob/main/microagents/github.md)
