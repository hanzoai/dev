...
This agent helps create new microagents in the `.hanzo/microagents` directory by providing guidance and templates.
...
* Create a markdown file in `.hanzo/microagents/` with an appropriate name (e.g., `github.md`, `google_workspace.md`)
