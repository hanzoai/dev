...
This agent helps create new microagents in the `.dev/microagents` directory by providing guidance and templates.
...
- Create a markdown file in `.dev/microagents/` with an appropriate name (e.g., `github.md`, `google_workspace.md`)
...
- [Microagents Syntax](https://docs.hanzo.ai/modules/usage/prompting/microagents-syntax)
- [Example GitHub Microagent](https://github.com/hanzoai/dev/blob/main/microagents/knowledge/github.md)
