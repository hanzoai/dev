...
impl SlashCommand {
    ...
    pub fn description(self) -> &'static str {
        match self {
            ...
            SlashCommand::Init => "create an AGENTS.md file with instructions for Dev",
            SlashCommand::Compact => "summarize conversation to prevent hitting the context limit",
            SlashCommand::Undo => "restore the workspace to the last Dev snapshot",
            SlashCommand::Review => "review your changes for potential issues",
            SlashCommand::Cloud => "browse, apply, and create cloud tasks",
            SlashCommand::Quit => "exit Dev",
            ...
            SlashCommand::Login => "manage Dev sign-ins (add/select/disconnect)",
            SlashCommand::Logout => "log out of Dev",
            #[cfg(debug_assertions)]
