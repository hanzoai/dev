...
use hanzo_protocol::dynamic_tools::DynamicToolCallRequest;
...
pub use hanzo_protocol::protocol::McpListToolsResponseEvent;
pub use hanzo_protocol::protocol::McpServerFailure;
pub use hanzo_protocol::protocol::McpServerFailurePhase;
...
pub use hanzo_protocol::request_user_input::RequestUserInputEvent;
pub use hanzo_protocol::request_user_input::RequestUserInputResponse;
...
pub struct ExecApprovalRequestEvent {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub additional_permissions: Option<hanzo_protocol::models::PermissionProfile>,
}
