...
pub struct ExecInvokeArgs<'a> {
    ...
    pub hanzo_linux_sandbox_exe: &'a Option<PathBuf>,
...
impl Session {
    ...
    async fn run_exec_with_events_inner<'a>(
        ...
        let ExecInvokeArgs { params, sandbox_type, sandbox_policy, sandbox_cwd, hanzo_linux_sandbox_exe, stdout_stream } = exec_args;
        ...
        let result = process_exec_tool_call(params, sandbox_type, sandbox_policy, sandbox_cwd, hanzo_linux_sandbox_exe, stdout_stream)
        .await;
    ...
    async fn run_hook_command(
        ...
        let exec_args = ExecInvokeArgs {
            ...
            hanzo_linux_sandbox_exe: &self.hanzo_linux_sandbox_exe,
            stdout_stream: None,
        };
