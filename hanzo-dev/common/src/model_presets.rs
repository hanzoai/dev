...
pub const HIDE_GPT_5_3_CODEX_MIGRATION_PROMPT_CONFIG: &str = "hide_gpt5_3_codex_migration_prompt";
    ...
    vec![
        ...
        ModelPreset {
            ...
            upgrade: Some(ModelUpgrade {
                ...
                migration_config_key: HIDE_GPT_5_3_CODEX_MIGRATION_PROMPT_CONFIG.to_string(),
            }),
            show_in_picker: true,
        },
        ModelPreset {
