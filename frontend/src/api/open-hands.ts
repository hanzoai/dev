...
class Hanzo {
  ...
  static async getModels(): Promise<string[]> {
    const { data } = await hanzo.get<string[]>("/api/options/models");
    return data;
  }
  ...
  static async getAgents(): Promise<string[]> {
    const { data } = await hanzo.get<string[]>("/api/options/agents");
    return data;
  }
  ...
  static async getSecurityAnalyzers(): Promise<string[]> {
    const { data } = await hanzo.get<string[]>(
  ...
  static async getConfig(): Promise<GetConfigResponse> {
    const { data } = await hanzo.get<GetConfigResponse>(
      "/api/options/config",
    );
    return data;
  }
  ...
  static async getFiles(
    ...
    const { data } = await hanzo.get<string[]>(url, {
      params: { path },
    });
    return data;
  }
  ...
  static async getFile(conversationId: string, path: string): Promise<string> {
    ...
    const { data } = await hanzo.get<{ code: string }>(url, {
      params: { file: path },
    });
  ...
  static async submitFeedback(
    ...
    const { data } = await hanzo.post<FeedbackResponse>(url, feedback);
    return data;
  }
  ...
  static async authenticate(
    ...
    const response =
      await hanzo.post<AuthenticateResponse>("/api/authenticate");
  ...
  static async getWorkspaceZip(conversationId: string): Promise<Blob> {
    ...
    const response = await hanzo.get(url, {
      responseType: "blob",
    });
  ...
  static async getGitHubAccessToken(
    ...
    const { data } = await hanzo.post<GitHubAccessTokenResponse>(
  ...
  static async getVSCodeUrl(
    ...
    const { data } = await hanzo.get<GetVSCodeUrlResponse>(
  ...
  static async getRuntimeId(
    ...
    const { data } = await hanzo.get<{ runtime_id: string }>(
  ...
  static async getUserConversations(): Promise<Conversation[]> {
    const { data } = await hanzo.get<ResultSet<Conversation>>(
  ...
  static async deleteUserConversation(conversationId: string): Promise<void> {
    await hanzo.delete(`/api/conversations/${conversationId}`);
  }
  ...
  static async updateUserConversation(
    ...
    await hanzo.patch(`/api/conversations/${conversationId}`, conversation);
  }
  ...
  static async createConversation(
    ...
    const { data } = await hanzo.post<Conversation>(
      "/api/conversations",
      body,
    );
  ...
  static async getConversation(
    ...
    const { data } = await hanzo.get<Conversation | null>(
  ...
  static async getSettings(): Promise<ApiSettings> {
    const { data } = await hanzo.get<ApiSettings>("/api/settings");
    return data;
  }
  ...
  static async saveSettings(
    ...
    const data = await hanzo.post("/api/settings", settings);
  ...
  static async getBalance(): Promise<string> {
    const { data } = await hanzo.get<{ credits: string }>(
      "/api/billing/credits",
    );
    return data.credits;
  }
  ...
  static async getGitHubUser(): Promise<GitHubUser> {
    const response = await hanzo.get<GitHubUser>("/api/github/user");
  ...
  static async getGitHubUserInstallationIds(): Promise<number[]> {
    const response = await hanzo.get<number[]>("/api/github/installations");
    return response.data;
  }
  ...
  static async getTrajectory(
    ...
    const { data } = await hanzo.get<GetTrajectoryResponse>(
