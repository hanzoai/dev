...
export enum I18nKey {
  ...
  CONFIGURATION$HANZO_WORKSPACE_DIRECTORY_INPUT_LABEL = "CONFIGURATION$HANZO_WORKSPACE_DIRECTORY_INPUT_LABEL",
  ...
  LLM$MODEL = "LLM$MODEL",
  CONFIGURATION$HANZO_WORKSPACE_DIRECTORY_INPUT_PLACEHOLDER = "CONFIGURATION$HANZO_WORKSPACE_DIRECTORY_INPUT_PLACEHOLDER",
