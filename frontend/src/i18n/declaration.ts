...
export enum I18nKey {
  ...
  CONFIGURATION$DEV_WORKSPACE_DIRECTORY_INPUT_LABEL = "CONFIGURATION$DEV_WORKSPACE_DIRECTORY_INPUT_LABEL",
  ...
  LLM$MODEL = "LLM$MODEL",
  CONFIGURATION$DEV_WORKSPACE_DIRECTORY_INPUT_PLACEHOLDER = "CONFIGURATION$DEV_WORKSPACE_DIRECTORY_INPUT_PLACEHOLDER",
