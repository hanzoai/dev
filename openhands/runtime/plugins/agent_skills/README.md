...
This folder implements a skill/tool set `agentskills` for Hanzo.
...
The skill set can contain a bunch of wrapped tools for agent ([many examples here](https://github.com/hanzoai/Hanzo/pull/1914)), for example:
