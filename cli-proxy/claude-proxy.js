...
async function handleRequest(req, res) {
    ...
    if (url.pathname === '/v1/models' && req.method === 'GET') {
        ...
        res.end(JSON.stringify({
            object: 'list',
            data: [
                { id: 'claude-cli', object: 'model', created: Date.now(), owned_by: 'anthropic' },
                { id: 'claude-opus', object: 'model', created: Date.now(), owned_by: 'anthropic' },
                { id: 'claude-sonnet', object: 'model', created: Date.now(), owned_by: 'anthropic' },
                { id: 'claude-haiku', object: 'model', created: Date.now(), owned_by: 'anthropic' }
            ]
        }));
        return;
    }
