...
pub const HIDE_GPT_5_1_DEV_MAX_MIGRATION_PROMPT_CONFIG: &str =
    "hide_gpt-5.1-codex-max_migration_prompt";
pub const HIDE_GPT_5_2_MIGRATION_PROMPT_CONFIG: &str = "hide_gpt5_2_migration_prompt";
pub const HIDE_GPT_5_2_DEV_MIGRATION_PROMPT_CONFIG: &str = "hide_gpt5_2_codex_migration_prompt";
    ...
    vec![
        ...
        ModelPreset {
            ...
            upgrade: Some(ModelUpgrade {
                ...
                migration_config_key: HIDE_GPT_5_2_DEV_MIGRATION_PROMPT_CONFIG.to_string(),
            }),
            pro_only: false,
