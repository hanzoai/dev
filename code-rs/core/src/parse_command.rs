...
mod tests {
    ...
    fn supports_grep_recursive_current_dir() {
        assert_parsed(
            &vec_str(&["grep", "-R", "DEV_SANDBOX_ENV_VAR", "-n", "."]),
            vec![ParsedCommand::Search {
                cmd: "grep -R DEV_SANDBOX_ENV_VAR -n .".to_string(),
                query: Some("DEV_SANDBOX_ENV_VAR".to_string()),
                path: Some(".".to_string()),
            }],
        );
    }
    ...
    fn supports_grep_recursive_specific_file() {
        assert_parsed(
            ...
            vec![ParsedCommand::Search {
                cmd: "grep -R DEV_SANDBOX_ENV_VAR -n core/src/spawn.rs".to_string(),
                query: Some("DEV_SANDBOX_ENV_VAR".to_string()),
