...
pub const DEV_SANDBOX_NETWORK_DISABLED_ENV_VAR: &str = "DEV_SANDBOX_NETWORK_DISABLED";
...
pub const DEV_SANDBOX_ENV_VAR: &str = "DEV_SANDBOX";
...
/// `DEV_SANDBOX_NETWORK_DISABLED_ENV_VAR` environment variable.
pub(crate) async fn spawn_child_async(
    ...
    if !sandbox_policy.has_full_network_access() {
        cmd.env(DEV_SANDBOX_NETWORK_DISABLED_ENV_VAR, "1");
    }
