...
mod tests {
    ...
    async fn unified_exec_persists_across_requests_jif() -> Result<(), UnifiedExecError> {
        ...
        manager
            .handle_request(UnifiedExecRequest {
                ...
                input_chunks: &[
                    "export".to_string(),
                    "DEV_INTERACTIVE_SHELL_VAR=codex\n".to_string(),
                ],
                timeout_ms: Some(2_500),
            })
            .await?;
        ...
        let out_2 = manager
            .handle_request(UnifiedExecRequest {
                session_id: Some(session_id),
                input_chunks: &["echo $DEV_INTERACTIVE_SHELL_VAR\n".to_string()],
                timeout_ms: Some(2_500),
            })
            .await?;
    ...
    async fn multi_unified_exec_sessions() -> Result<(), UnifiedExecError> {
        ...
        manager
            .handle_request(UnifiedExecRequest {
                ...
                input_chunks: &["export DEV_INTERACTIVE_SHELL_VAR=codex\n".to_string()],
                timeout_ms: Some(2_500),
            })
            .await?;
    ...
    async fn unified_exec_timeouts() -> Result<(), UnifiedExecError> {
        ...
        let out_2 = manager
            .handle_request(UnifiedExecRequest {
                session_id: Some(session_id),
                input_chunks: &["sleep 5 && echo $DEV_INTERACTIVE_SHELL_VAR\n".to_string()],
                timeout_ms: Some(10),
            })
            .await?;
        assert!(!out_2.output.contains("codex"));
