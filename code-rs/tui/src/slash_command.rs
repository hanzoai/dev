...
const BUILD_PROFILE: Option<&str> = option_env!("DEV_PROFILE");
...
impl SlashCommand {
    ...
    pub fn description(self) -> &'static str {
        match self {
            ...
            SlashCommand::Undo => "restore the workspace to the last Hanzo Dev snapshot",
            ...
            SlashCommand::Login => "manage Hanzo Dev sign-ins (add/select/disconnect)",
